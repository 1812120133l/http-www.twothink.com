<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\www\www.twothink.com\public/../application/admin/view/default/notice\add.html";i:1542122831;s:81:"D:\www\www.twothink.com\public/../application/admin/view/default/public\base.html";i:1542007819;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" name="introduce" value="<?php echo (isset($info['introduce']) && ($info['introduce'] !== '')?$info['introduce']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">浏览</label>
        <div class="controls">
            <input type="text" class="text input-large" name="flow" value="<?php echo (isset($info['flow']) && ($info['flow'] !== '')?$info['flow']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">图片</label>
        <div class="controls">
            <input type="file" class="text input-large" name="img" value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>">
        </div>
    </div>
    <div class="form-item">
        <label class="item-label">内容</label>
        <div class="controls">
            <textarea style="width: 400px" name="content"><?php echo $info['content']; ?></textarea>
        </div>
    </div>
    <div class="form-item">
