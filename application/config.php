...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '>Fvc%IY&AE.(~d6e8ZQRxKB51C$)W=tVDlHLn}Pg', //默认数据加密KEY
	'data_cache_key'=> '>Fvc%IY&AE.(~d6e8ZQRxKB51C$)W=tVDlHLn}Pg',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'>Fvc%IY&AE.(~d6e8ZQRxKB51C$)W=tVDlHLn}Pg', //加密KEY
